...
const userNameValue = (document.querySelector('#user-name') as HTMLInputElement).value;
let comments: Comment[] = [];

document.querySelector('#start-button').addEventListener('click', () => {
  (document.querySelector('#start-div') as HTMLDivElement).style.display = 'none';
  (document.querySelector('#welcome-massage') as HTMLHeadingElement).innerText = `Hello ${userNameValue} if u want to delete your old comments click on it !!!`;
